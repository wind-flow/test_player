...
class AudioUi extends StatelessWidget {
  ...
  @override
  void initState() {
    var audioHivRepository = AudioHiveRepository();
    audioHivRepository.audioRead();
  }
  ...
  Widget build(BuildContext context) {
    ...
    //     // future: audioPlayerController.refreshPlayList(),
    //     builder: (context, snapshot) {
    //       if (audioPlayerController.streams.isEmpty == true) {
    //         return Container();
    ...
    //                       audioPlayerController.deletePlayList(index);
    //                     },
    //                     child: InkWell(
    ...
    return Obx(
      () => ListView.builder(
        ...
        physics: const BouncingScrollPhysics(),
        itemBuilder: ((context, index) {
          LoggerController.logger.d(audioPlayerController.streams.length);
          return Obx(() => (Dismissible(
                key: Key(audioPlayerController.streams[index].id.toString()),
                onDismissed: (direction) {
                  audioPlayerController.deletePlayList(index);
                },
                child: InkWell(
                  ...
                  child: Container(
                    height: 52.sp,
                    decoration: BoxDecoration(
                      color: (audioPlayerController.currentStreamIndex.value ==
                              index)
                          ? Color(0xFF2A2A2A)
                          : Colors.transparent,
                      borderRadius: BorderRadius.all(
